...
exports.createSignatureRequest = functions
  .runWith({ secrets: ['HELLOSIGN_API_KEY', 'HELLOSIGN_CLIENT_ID'] })
...
exports.createTemplateRequest = functions
  .runWith({ secrets: ['HELLOSIGN_API_KEY', 'HELLOSIGN_CLIENT_ID'] })
  .https.onRequest((req, res) => {
    cors(req, res, async () => {
      try {
...
exports.getSignatureStatus = functions
  .runWith({ secrets: ['HELLOSIGN_API_KEY'] })
  .https.onRequest((req, res) => {
    cors(req, res, async () => {
      try {
        // Check authentication
...
exports.downloadSignedDocument = functions
  .runWith({ secrets: ['HELLOSIGN_API_KEY'] })
  .https.onRequest((req, res) => {
    cors(req, res, async () => {
      try {
...
// List all templates
exports.listTemplates = functions
  .runWith({ secrets: ['HELLOSIGN_API_KEY'] })
  .https.onRequest((req, res) => {
    cors(req, res, async () => {
      try {
...
exports.helloSignWebhook = functions
  .runWith({ secrets: ['HELLOSIGN_API_KEY'] })
