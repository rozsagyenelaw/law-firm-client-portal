      ...
      <div style={{ maxWidth: '448px', width: '100%' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '24px' }}>
            <Shield style={{ height: '48px', width: '48px', color: '#1e3a8a' }} />
          </div>
        ...
        {!isSignup ? (
          <div style={{ backgroundColor: 'white', padding: '32px', borderRadius: '8px', boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1)' }}>
            ...
            <div style={{ marginBottom: '16px', position: 'relative' }}>
              ...
              >
                {showPassword ? <EyeOff style={{ height: '16px', width: '16px', color: '#9ca3af' }} /> : <Eye style={{ height: '16px', width: '16px', color: '#9ca3af' }} />}
              </button>
            </div>
